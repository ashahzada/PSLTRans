...
/** Auto Quit option key name. */
	public static final String				AUTO_QUIT = "do.auto.quit";
        ...
        public static SiGMLPlayer playerInstance = null;
...
/** Main method -- creates a new instance of the app with the given CL args. */
	...
	throws InterruptedException, InvocationTargetException, IOException {
            ...
            String [] args1 = {"-session", "file:../SiGMLPlayer", "-ja.version.tag=loc2016", "-ja.remote.base.url=file:../../loc2016/"};
		...
		SiGMLPlayer jasuapp = new SiGMLPlayer(args1);
                jasuapp.mainFrame.setVisible(false);
 ...
 */
	public SiGMLPlayer(String[] args)
	throws InterruptedException, InvocationTargetException, IOException {
		...
		tmr.showTimeMS("SiGMLPlayer: Complete set-up time");
                //this.avatarPane.setBackground(Color.yellow);
...
/** Creates the GUI for this player app, packs it and displays it. */
	protected void createGUI() { // throws IOException {
		...
		//this.window = new JFrame("SiGML Player");
                this.mainFrame = new JFrame("SiGML Player");
                this.mainFrame.setLayout(new FlowLayout());
                this.mainPanel = new JPanel();
                mainPanel.setLayout(new FlowLayout());
                this.window = new JPanel();

                JPanel translationFrame = new TranslationWithAvatar();
                
                mainPanel.add(translationFrame);
                mainPanel.add(window);
                mainFrame.add(mainPanel);
                mainFrame.setDefaultCloseOperation(WindowConstants.HIDE_ON_CLOSE);
		this.mainPane = this.makeMainPane();
                this.mainPane.setBackground(new Color(182,207,164));
                this.mainPanel.setBackground(new Color(182,207,164));
		...
		this.mainFrame.setLocation(this.winX, this.winY);
		this.mainFrame.pack();
