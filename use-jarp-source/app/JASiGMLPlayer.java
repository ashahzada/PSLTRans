...
//        System.getProperties().list(System.out);
        ...
        Properties argProps = AppletPropertiesSetter.argsToProperties(args1);
...
//        System.getProperties().list(System.out);
		...
		this.JA_OPTS =
			JAOptions.makeJAOptions(
				"JASiGMLPlayer", args1, argProps, JAEnv.makeAppJAEnv());
		...
		this.player.requestSwitchAvatar(avatar);
                ...
                //this.mainPane.setBackground(Color.yellow);
